 ...
 */
function NonDataEditComp({ value, onChange, component, siteType, pageFormat, onHandle: parentOnHandle, sectionId, trackingId, activeStyle }) {
 ...
 */
const EditComp = forwardRef(({value, onChange, compKey, component, siteType, pageFormat, onHandle, sectionId, trackingId, activeStyle}, ref) => {
    const updateAttribute = (k, v) => {
        if (!isEqual(value, {...value, [k]: v})) {
            onChange({...value, [k]: v})
        }
...
const ViewComp = forwardRef(({value, onChange, siteType, pageFormat, refreshDataBtnRef, component, editPageMode, onHandle, sectionId, trackingId, activeStyle}, ref) => {
