...
import { usePrevious } from '../../../../../../mapeditor/MapEditor/components/LayerManager/utils'
...
export const MapDamaEdit = ({value, onChange, size}) => {
    ...
    }, [mounted.current, state.symbologies])
