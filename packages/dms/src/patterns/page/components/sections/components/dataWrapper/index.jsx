...
const Edit = forwardRef((props, ref) => {
    let {cms_context, value, onChange, component, siteType, pageFormat, onHandle, sectionId} = props
    ...
    usePageFilterSync({ state, setState, sectionId });
    ...
    return (
        <ComponentContext.Provider value={{state, setState, apiLoad, apiUpdate, controls: resolvedControls,
            isActive: true, activeStyle: undefined, sectionId}}>
...
const View = forwardRef(({cms_context, value, onChange, component, editPageMode, onHandle, sectionId}, ref) => {
    const isEdit = false;
    ...
    usePageFilterSync({ state, setState, setReadyOnChange: true, sectionId });
    ...
    return (
        <ComponentContext.Provider value={{state, setState, apiLoad, apiUpdate, controls: resolvedControls, activeStyle: undefined, sectionId}}>
