const defaultMapStyle = {
  ...
  legend: {
    ...
    title: "w-full text-sm text-slate-600 font-medium truncate flex justify-between flex-wrap",
...
const currentDefault2Style = {
  ...
  legend: {
    panel: "p-4",
    panelInner:
      "relative min-h-10 max-h-[calc(100vh_-_111px)] overflow-auto rounded-lg border border-zinc-950/10 bg-white/95 shadow-sm pointer-events-auto scrollbar-sm",
    section: "m-1 rounded p-1",
    row: "rounded-md border border-transparent transition-colors",
    rowHover: "hover:border-zinc-950/15 hover:bg-blue-500/5",
    rowActive: "border-blue-500/30 bg-blue-500/10",
    titleRow: "group/title flex w-full items-center p-2 py-1",
    title: "flex w-full flex-wrap justify-between truncate text-sm font-medium text-zinc-700",
    label: "flex h-6 flex-1 items-center truncate px-4 text-center text-sm text-zinc-600",
    secondaryLabel: "text-xs text-zinc-500",
    groupLabel: "truncate flex-1 font-medium text-zinc-700",
    groupMetaLabel: "text-xs text-zinc-500",
    symbolWrapper: "flex h-6 w-10 items-center justify-center",
    symbolFill: "h-4 w-4 rounded",
    symbolCircle: "h-3 w-3 rounded-full",
    symbolLine: "h-1 w-4",
    horizontalPanel: "w-full max-h-[350px] overflow-x-auto scrollbar-sm",
  ...
  hover: {
    ...
    value: "flex-1 pl-4 pr-1 text-right text-sm font-normal text-zinc-700",
    removeButton:
