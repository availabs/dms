...
const theme = {
    multiselect: {
        ...
        optionsWrapper: 'max-h-[300px] overflow-auto [&::-webkit-scrollbar]:h-[6px] [&::-webkit-scrollbar]:w-[6' +
            'px] [&::-webkit-scrollbar]:bg-white [&::-webkit-scrollbar]:rounded-[10px] [&::-webkit-scrollbar-thumb]:bg-[#bbb] [&::-webkit-scrollbar-thumb:hover]:bg-[#888] [&::-webkit-scrollbar-thumb]:rounded-[10px]',
        ...
        smartMenuItem: 'w-fit px-1 py-0.5 m-1 bg-blue-100 hover:bg-blue-300 hover:cursor-pointer transition ease-in border rounded-full text-xs',
