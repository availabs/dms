...
- [ ] Pivot table grouped column headers — add multi-row `<thead>` to the Table component so multiple pivot columns render with a spanning parent header row per pivot column value (Option B follow-up to pivot table support)
