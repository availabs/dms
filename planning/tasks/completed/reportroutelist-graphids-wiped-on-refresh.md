...
**Initiatives:** [tny_npmrds_reports_1_0](../../../../../planning/initiatives/tny_npmrds_reports_1_0.md) (primary), [dms_author_primitives](../../../../../planning/initiatives/dms_author_primitives.md) · **Status:** done (was: "FIXED AND LIVE-VERIFIED 2026-07-20.") · **Created by:** rdubowsky@albany.edu · **Edited by:** —
...
- **~25+ stray duplicate `reports_snap_2` rows** on page 13 (report_id `2195012`) are cleanup debt
  ...
  `planning/transportny/tasks/completed/reportroutelist.md`'s "Open items" section for the full record
  (backup file, delete mechanism, post-cleanup verification).

## Next steps (not yet done)

- [x] Clean up the stray duplicate rows — **DONE 2026-08-24**, see
  `planning/transportny/tasks/completed/reportroutelist.md`'s "Open items" section for the full
