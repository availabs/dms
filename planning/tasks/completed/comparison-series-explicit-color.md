...
**Initiatives:** [tny_npmrds_reports_1_0](../../../../../planning/initiatives/tny_npmrds_reports_1_0.md) (primary), [dms_author_primitives](../../../../../planning/initiatives/dms_author_primitives.md) · **Status:** done (was: "IMPLEMENTED, live-verified 2026-07-22. Planned 2026-07-22, built same day.") · **Created by:** rdubowsky@albany.edu · **Edited by:** amuro@albany.edu
...
Library-side half of the root-level task `planning/transportny/tasks/completed/report-page-redesign.md`
...
- `planning/transportny/tasks/completed/report-page-redesign.md` (dms-template repo root) — the
