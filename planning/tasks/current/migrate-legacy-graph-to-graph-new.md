...
**Initiatives:** [dms_author_primitives](../../../../../planning/initiatives/dms_author_primitives.md) · **Status:** done (was: "STATUS: IMPLEMENTED, with three post-ship fixes. … Live-render verification (the Testing Checklist) …"; not moved: the doc's own wording doesn't say done — confirm, then move to completed/) · **Created by:** ssangdod@albany.edu · **Edited by:** rdubowsky@albany.edu
