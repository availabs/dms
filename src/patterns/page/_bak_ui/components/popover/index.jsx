...
export default function PopoverComp ({ children, button, onClick=()=>{}, anchor='bottom', width='max-w-sm lg:max-w-lg', ...props}) {
  const { theme = { popover: popoverTheme } } = React.useContext(ThemeContext) || {}
    ...
    const defaultButton = <Icon icon={'InfoSquare'} className='text-blue-400 hover:text-blue-600  w-[24px] h-[24px]' title="Help Text" />
  return (
