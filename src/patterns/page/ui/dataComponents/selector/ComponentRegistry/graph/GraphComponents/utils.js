...
export const mapColors = {
  ...
  "div7": {
    ...
    20: ["#D72638", "#007F5F", "#F8A100", "#38BFA7",
      "#8F2D56", "#E2C044", "#6A4C93", "#A8C686",
      "#FF5D73", "#5296A5", "#CC5803", "#F4B6C2",
      "#6D597A", "#2E294E", "#D4A373", "#73C2FB",
      "#FFDD67", "#845EC2", "#F96167", "#4B88A2"]
  }
