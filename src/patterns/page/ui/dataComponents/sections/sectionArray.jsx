...
// const SectionEdit = () => <div>Section Edit</div>
// const SectionView = () => <div>Section View</div>
...
const Edit = ({ value, onChange, attr, group, siteType, ...rest }) => {
    ...
    const { UI, baseUrl, user, theme = { sectionArray: sectionArrayTheme} } = React.useContext(CMSContext) || {}
