    ...
    return (
        <div className="relative inline-block text-left">
            <Popup button={<div
                                ...
                                >
                Appearance <Icon icon={'ArrowDown'} height={18} width={18} className={'mt-1'}/>
            </div>}>
                {
                    ({open, setOpen}) => (
                        <div
                             className={`${open ? 'visible transition ease-in duration-200' : 'hidden transition ease-in duration-200'} absolute left-0 z-10 w-72 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition focus:outline-none`}
                        >
