...
export class CollapsibleNoPreviewContainerNode extends ElementNode {
  __open: boolean;
  ...
  static getType(): string {
    return 'collapsible-no-preview-container';
  }

  static clone(node: CollapsibleNoPreviewContainerNode): CollapsibleNoPreviewContainerNode {
    return new CollapsibleNoPreviewContainerNode(node.__open, node.__key);
  }
  ...
  updateDOM(
    prevNode: CollapsibleNoPreviewContainerNode,
  ...
  exportJSON(): SerializedCollapsibleContainerNode {
    return {
      ...super.exportJSON(),
      open: this.__open,
      type: 'collapsible-no-preview-container',
      version: 1,
    };
  }
...
export function $createCollapsibleContainerNode(
  ...
  return new CollapsibleNoPreviewContainerNode(isOpen);
}

export function $isCollapsibleContainerNode(
  node: LexicalNode | null | undefined,
): node is CollapsibleNoPreviewContainerNode {
  return node instanceof CollapsibleNoPreviewContainerNode;
}
